...
def init_spixel_grid(args,  b_train=True, scale=1):
    if b_train:
        img_height, img_width = args.train_img_height//scale, args.train_img_width//scale
    else:
...
def poolfeat(input, prob, sp_h=2, sp_w=2):
    ...
    #located at the center superpixel, represents the probability of current center to the left top superpixel
...
#===========================================================================================
def init_spixel_grid_test(img_height, img_width,args):
